 ...
 *                                                                    *
 * Copyright © 2008 The Khronos Group                            	  *
 *                                                                    *
 **********************************************************************/
...
typedef enum {
  ...
  VG_sXRGB_8888                               = 0x40,
  VG_sARGB_8888                               = 0x41,
  VG_sARGB_8888_PRE                           = 0x42,
  VG_sARGB_1555                               = 0x44,
  VG_sARGB_4444                               = 0x45,
  VG_lXRGB_8888                               = 0x47,
  VG_lARGB_8888                               = 0x48,
  VG_lARGB_8888_PRE                           = 0x49,

  /* BGR{A,X} channel ordering */
  VG_sBGRX_8888                               = 0x80,
  VG_sBGRA_8888                               = 0x81,
  VG_sBGRA_8888_PRE                           = 0x82,
  VG_sBGR_565                                 = 0x83,
  VG_sBGRA_5551                               = 0x84,
  VG_sBGRA_4444                               = 0x85,
  VG_lBGRX_8888                               = 0x87,
  VG_lBGRA_8888                               = 0x88,
  VG_lBGRA_8888_PRE                           = 0x89,

  /* {A,X}BGR channel ordering */
  VG_sXBGR_8888                               = 0xc0,
  VG_sABGR_8888                               = 0xc1,
  VG_sABGR_8888_PRE                           = 0xc2,
  VG_sABGR_1555                               = 0xc4,
  VG_sABGR_4444                               = 0xc5,
  VG_lXBGR_8888                               = 0xc7,
  VG_lABGR_8888                               = 0xc8,
  VG_lABGR_8888_PRE                           = 0xc9
} VGImageFormat;
...
VG_API_CALL void VG_APIENTRY
    vgSetGlyphToPath(VGFont font,
        ...
        const VGfloat *escapement) VG_APIEXIT;
VG_API_CALL void VG_APIENTRY
...
void vgiEglBridge(void);
void vgiVGIBridge(void);
